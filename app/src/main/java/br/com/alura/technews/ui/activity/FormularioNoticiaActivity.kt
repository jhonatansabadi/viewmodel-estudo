...
class FormularioNoticiaActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy {
        val factory = FormularioNoticiaViewModelFactory(repository, noticiaId)
        ViewModelProviders.of(this, factory).get(FormularioViewModel::class.java)
    }
    ...
    private fun preencheFormulario() {
        viewModel.buscarPorId().observe(this, Observer {
            if (it != null) {
